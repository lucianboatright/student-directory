...
def student_input
  ...
  while !name.empty? do
    ...
    puts "And their hobbies?"  # first in loop as it takes in hobbies set to name given outside loop
    hobbies = gets.chomp
    # add the student hash to the array
    students << {name: name, hobbies: hobbies, cohort: :november} # added hobbies
